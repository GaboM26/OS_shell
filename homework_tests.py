...
t.add_test("/bin/ls /home/gabomba/w4118", "lab1")
t.add_test("/home", GENERAL_ERROR)
t.add_test("/home/gabomba/a.out", "Hello World")
t.add_test("cd ..", "")
t.add_test("/", GENERAL_ERROR)
t.add_test("cd /home/gabomba", "")
t.add_test("./a.out", "Hello World")
t.add_test("cd w4118", "")
t.add_test("../a.out", "Hello World")
t.run()
t.print_results()
